...
if (temperature >= 80 && rain) {
  ...
  console.log("Wear a jcket and carry an umbrella.");
} else if (temperature >= 80 && !rain) {
  console.log("Wear a t-shirt and sandals.");
} else if (temperature > 60 && temperature < 80 && !rain) {
...
/*
  Create a for-loop that logs the numbers 0 through 10 backwards. Ex, on the first iteration it would log 10, on 
  the second iteration it would log 9.
*/
...
/*
  ...
  In each iteration of the loop, increase the score by one. If your code is successful, you will see your logged statement 7
   times.
*/
