...
test("can search Google for 'automation'", async () => {
  ...
  await driver.wait(until.titleIs("automation - Google Search"), 1000000);
});
...
test("can search Google twice", async () => {
  ...
  await driver.findElement(By.name("q")).sendKeys("must see travel destinations", Key.RETURN);
  await driver.wait(until.titleIs("must see travel destinations - Google Search"), 1000000);
  ...
  await driver.findElement(By.name("q")).sendKeys("cheapest flights from MSP", Key.RETURN);
  await driver.wait(until.titleIs("cheapest flights from MSP - Google Search"), 1000000);
