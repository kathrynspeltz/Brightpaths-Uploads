...
function printName(person1name) {
...
function greeting(person1name) {
  console.log("Hello " + person1name)
}
...
function add(param1, param2) {
  let newparam1 = Number(param1)
  let newparam2 = Number(param2)
...
const bestMovie = string1 => string1 + "is the best movie ever!"
