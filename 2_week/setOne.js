...
////////// PROBLEM 2 //////////
/*
Write a one line function (give a name of your choice) with an implicit return that when the function is invoked, it will print: 'The first parameter is [parameter1]. 
The second parameter is [parameter2]'.
*/

// CODE HERE
const newFunct = (num1, num2) => console.log(`The first parameter is ${num1}. The second parameter is ${num2}`)
...
const callBack = (fullName) => console.log(`Hello my name is ${fullName}`)
greeting("Kathryn", "Speltz", callBack)
...
const cbPrice = (totalCost) => console.log(`The new array plus tax = ${totalCost}`)
pricesPlusTax(prices, cbPrice)
...
The inner function should run this logic: if the first number passing in is greater than and equal to 3, print the multiplication of the first and second numbers. 
If not, print "Cannot multiply: the first number is smaller than 3."
*/
...
function multiplyingFactory(number1) {
    return function (number2) {
        if (number1 >= 3) {
            ...
            console.log("Cannot multiply: the first number is smaller than 3.")
        }
    }
}

let timesFour = multiplyingFactory(4)
let timesSix = multiplyingFactory(6)
