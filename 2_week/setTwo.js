...
// CODE HERE 
function contains(array, name1, callback) {
...
function each(arrayNames, callback5) {
  for (let i = 0; i < arrayNames.length; i++) {
    callback5(arrayNames[i], i)
  }
}
...
// CODE HERE
const callBack2 = (indexparam1, indexparam2) => console.log(`The item at index ${indexparam2} is ${indexparam1}`)
each(names, callBack2)
